...
//      when we use LinkedHashSet then insertion of elements will happen in same order they were inserted.We can't insert duplicates value in the TreeSet
        Set<Integer> setItems = new LinkedHashSet<>();
